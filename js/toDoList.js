let addIcon = document.querySelector('#type svg');
let toDoItem = document.querySelector('#type input');
...
addIcon.onclick = function(){
    ...
    let deleteIconReal = document.querySelectorAll('.list ul li svg');

    for(let i = 0; i < deleteIconReal.length; i++){
